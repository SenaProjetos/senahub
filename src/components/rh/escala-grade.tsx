 ...
 * (override) ou a herdada da contratação quando não há override. Presentational e puro
...
export function EscalaGrade({
  ...
  const linhas = temOverride ? dias : padraoDias;
  return (
    <div className="space-y-3">
      <p className="text-sm text-muted-foreground">
        {temOverride ? "Escala própria (substitui a da contratação)." : "Herdada da contratação (sem escala própria)."}
      </p>

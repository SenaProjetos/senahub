...
import { Settings2, Receipt, ArrowDownToLine, ArrowUpFromLine, BarChart3 } from "lucide-react";
...
const ATALHOS = [
  ...
  { href: "/financeiro/folha-projetistas", icon: Receipt, titulo: "Folha de projetistas", desc: "Pagamentos por entrega" },

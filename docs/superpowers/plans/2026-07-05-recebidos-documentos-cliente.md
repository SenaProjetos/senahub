...
| **5a (futuro)** | Absorver o "Geral" interno (`ArquivoProjeto`) → `Documento(origem=interno)`. Baixo risco. Plano: [documentos-fase5a-geral.md](../../concluidos/plans/2026-07-05-documentos-fase5a-geral.md) | 1–4 |

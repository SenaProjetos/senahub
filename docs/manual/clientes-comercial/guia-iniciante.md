...
Abra a **Empresa 360** para enxergar toda a relação com uma empresa: contatos, conversas,
prospecções, negociações, propostas, projetos e próxima ação. É o melhor lugar para retomar um
cliente meses depois sem perguntar ao time o que já aconteceu.

Na página **Comercial**, **Meu Dia** mostra retornos atrasados, contatos de hoje, próximas ações e
propostas que pedem atenção. Em **Inteligência**, os filtros ajudam a responder quais canais trazem
mais contratos e receita.

## Boas práticas

- Pesquise antes de cadastrar; uma empresa bem identificada evita trabalho duplicado.
- Registre a conversa no mesmo dia, enquanto o contexto está fresco.
- Termine cada interação criando ou conferindo a próxima ação.
- Use o motivo de perda de forma honesta: ele ajuda a gestão a entender onde melhorar.
- Não altere uma proposta aceita; crie uma cópia se o cliente pedir uma nova versão comercial.

Para detalhes de permissões, telas e erros, consulte [Comercial](comercial.md).

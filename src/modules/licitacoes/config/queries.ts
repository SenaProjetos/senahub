...
import { CHAVE_CONFIG_LICITACOES, parseConfigLicitacoes, type ConfigLicitacoes } from "@/modules/licitacoes/config/defaults";
...
export async function getConfigLicitacoes(): Promise<ConfigLicitacoes> {
  ...
  if (!c || typeof c.valor !== "object" || c.valor === null) return parseConfigLicitacoes(null);

...
tags: [glossário, termos, definições, conceitos, perfis, módulos]
palavras-chave: [glossário, significado, o que é, definição, termo, sigla]
...
| **Planejamento** | Cronograma e caminho crítico (CPM) | 🚧 |

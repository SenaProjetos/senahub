...
This repo already carries a large body of prose docs that predate this convention and are **not** a substitute for `CONTEXT.md` / ADRs, but are worth knowing about:

- `docs/HANDOFF.md`: point-in-time project state and decision log (per "Onda").
- `docs/superpowers/`: dated per-feature specs and plans.
- `docs/crm/`: the live plan for the `comercial` module reform (`01-decisoes.md` is a de-facto ADR set).

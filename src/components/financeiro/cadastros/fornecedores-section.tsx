...
const CATEGORIAS_INSUMO = Object.keys(CATEGORIA_INSUMO_LABEL);
...
export function FornecedoresSection({ fornecedores, podeCotacao }: { fornecedores: Fornecedor[]; podeCotacao: boolean }) {
      ...
      <DialogContent className="max-h-[90svh] overflow-y-auto sm:max-w-lg">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-1.5 border-t pt-3">
            <Label className="text-xs text-muted-foreground">Suprimentos (Engenharia de Custos)</Label>
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
